...
description: "A proposal for a new dynamic issuance policy for 1hive and the rest of gardens, exploring the process from math modeling to code implementation."
author: Sem
tags: [issuance policy, tokenomics, gardens]
pubDate: "2021-07-21"
---

> **Note:** The first version of this article was published in the [1hive forum](https://forum.1hive.org/t/dynamic-issuance-policy-v2-from-math-to-code-in-one-post/4214).
...
![Screenshot from 2021-07-31 21-02-00](./1.png)
...
![When r=8 the point (8,8) is touched by the curve](./2.png)
...
![When t=0.2 the point (8,0.2) is touched by the curve](./3.png)
...
![It is the same curve but flipped](./4.png)
...
![It is the same curve but translated to the top right](./5.png)
...
![Inverted curve coming from (0,1) point](./6.png)
...
!["Left-shifted" deflationary formula with c=0.4](./7.png)
...
![In this formula, we find the minimum at x=4, for any x>=4 the piecewise formula should return the target ratio](./8.png)
