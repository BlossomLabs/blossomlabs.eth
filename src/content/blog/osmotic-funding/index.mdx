...
description: "Osmotic Funding is a protocol built on top of Superfluid Finance and Conviction Voting to create and regulate project funding streams based on the interest a community has in them."
author: Sem
tags: [osmotic funding, nature]
pubDate: "2021-10-14"
---

> **Note:** You can find the first version of this article as a [hackmd](https://hackmd.io/0KwBbSNTSleYbAChGjkhyQ?view) published during the ETHOnline '21 hackathon.
